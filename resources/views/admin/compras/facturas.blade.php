        ...
        <div class="modal-content" style="background: rgba(20, 20, 25, 0.95); border: 1px solid rgba(230, 57, 70, 0.3);">
            ...
            <form action="{{ route('facturas-compra.store') }}" method="POST" id="formFactura">
                ...
                <div class="modal-body" style="color: #f0f0f0; padding: 1.5rem;">
                    ...
                    <div class="row mb-3" style="gap: 1rem; margin-bottom: 2rem;">

                        <!-- INFORMACIÓN GENERAL -->

                        <div class="col-md-6">

                            <div style="background: rgba(230, 57, 70, 0.05); padding: 1rem; border-radius: 6px; border-left: 3px solid #e63946;">

                                <h6 style="color: #e63946; font-weight: 700; font-size: 0.85rem; margin-bottom: 1rem; text-transform: uppercase;">ℹ️ Información General</h6>

                                <div class="mb-2">

                                    <span style="color: #a0a0a0; font-size: 0.75rem; text-transform: uppercase;">Proveedor</span>

                                    <p id="detalleProveedor" style="color: #f0f0f0; font-weight: 600; margin: 0; font-size: 1rem;">—</p>

                                </div>

                                <div class="mb-2">

                                    <span style="color: #a0a0a0; font-size: 0.75rem; text-transform: uppercase;">Albarán</span>

                                    <p id="detalleAlbaran" style="color: #e63946; font-weight: 600; margin: 0; font-size: 1rem;">—</p>

                                </div>

                                <div>

                                    <span style="color: #a0a0a0; font-size: 0.75rem; text-transform: uppercase;">Pedido</span>

                                    <p id="detallePedido" style="color: #f0f0f0; font-weight: 600; margin: 0; font-size: 1rem;">—</p>
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="background: rgba(230, 57, 70, 0.05); padding: 1rem; border-radius: 6px; border-left: 3px solid #e63946;">
                                ...
                                <div class="mb-2">
                                    ...
                                    <span style="color: #a0a0a0; font-size: 0.75rem; text-transform: uppercase;">Total Albarán</span>

                                    <p id="detalleTotal" style="color: #e63946; font-weight: 700; margin: 0; font-size: 1.3rem;">€0.00</p>

                                </div>

                                <hr style="border-color: rgba(230, 57, 70, 0.2); margin: 0.5rem 0;">

                                <div class="mb-2">

                                    <span style="color: #a0a0a0; font-size: 0.75rem; text-transform: uppercase;">Fecha Factura</span>

                                    <p style="color: #f0f0f0; font-weight: 600; margin: 0; font-size: 0.9rem;" id="fechaFacturaDisplay">—</p>

                                </div>

                                <div>

                                    <span style="color: #a0a0a0; font-size: 0.75rem; text-transform: uppercase;">Fecha Vencimiento</span>

                                    <p style="color: #f0f0f0; font-weight: 600; margin: 0; font-size: 0.9rem;" id="fechaVencimientoDisplay">—</p>
                    ...
                    <div class="table-responsive mb-2" style="border: 1px solid rgba(230, 57, 70, 0.2); border-radius: 6px;">
                        ...
                        <table class="table table-sm" id="tablaProductos" style="margin: 0;">
                            ...
                            <tbody id="productosFacturaList"></tbody>
                    ...
                    <!-- SECCIÓN 3: TABLA FORMAS DE PAGO -->

                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem;">

                        <h6 style="color: #e63946; font-weight: 700; font-size: 0.9rem; margin: 0;">💳 Formas de Pago</h6>

                        <button type="button" class="btn btn-sm btn-outline-success" onclick="window.CrearFacturaModal.agregarFilaPago()" style="border-color: #90ee90; color: #90ee90; font-size: 0.75rem;">
                    ...
                    <div class="table-responsive mb-2" style="border: 1px solid rgba(230, 57, 70, 0.2); border-radius: 6px;">
                        ...
                        <table class="table table-sm" id="tablaPagos" style="margin: 0;">
                            ...
                            <tbody id="pagosFacturaList" style="background: rgba(20, 20, 25, 0.8);">

                                <tr>

                                    <td colspan="7" style="text-align: center; padding: 1.5rem; color: #a0a0a0;">
