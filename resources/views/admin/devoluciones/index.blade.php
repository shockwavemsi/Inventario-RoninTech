...
<div style="background: linear-gradient(to right, #0d0d0e 0%, #111111 100%); border-bottom: 2px solid #0066cc; padding: 1.5rem 0; margin: -30px -30px 30px -30px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.5);">
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 30px; display: flex; justify-content: space-between; align-items: center;">
        <div style="display: flex; align-items: center; gap: 1rem;">
            <div style="width: 50px; height: 50px; background-color: #0066cc; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 28px; color: white;">📦</div>
            <div>
...
<div class="row mb-4" style="max-width: 1200px; margin: 2rem auto 0;">
    <div class="col-md-3">
        <div style="background: rgba(20, 20, 25, 0.65); border: 1px solid rgba(0, 102, 204, 0.2); border-radius: 8px; padding: 1.5rem;">
            <div style="display: flex; align-items: center; gap: 1rem;">
                <div style="font-size: 2rem;">📦</div>
                <div>
                    <span style="color: #a0a0a0; font-size: 0.85rem;">Total Devoluciones</span>
                    <strong style="color: #0066cc; font-size: 1.5rem; display: block;">0</strong>
                </div>
            </div>
        </div>
    </div>
        ...
        <div style="background: rgba(20, 20, 25, 0.65); border: 1px solid rgba(0, 102, 204, 0.2); border-radius: 8px; padding: 1.5rem;">
            <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div>
                    ...
                    <strong style="color: #ffc107; font-size: 1.5rem; display: block;">0</strong>
                </div>
            </div>
        </div>
    </div>
        ...
        <div style="background: rgba(20, 20, 25, 0.65); border: 1px solid rgba(0, 102, 204, 0.2); border-radius: 8px; padding: 1.5rem;">
            <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div>
                    ...
                    <strong style="color: #0066cc; font-size: 1.5rem; display: block;">€0.00</strong>
                </div>
            </div>
        </div>
    </div>
...
<div style="max-width: 1200px; margin: 2rem auto; padding: 0 30px;">
    <div style="background: rgba(20, 20, 25, 0.65); border: 1px solid rgba(0, 102, 204, 0.2); border-radius: 8px; padding: 1.5rem; backdrop-filter: blur(20px);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
            <h5 style="color: #0066cc; font-weight: 700; margin: 0;">📋 Devoluciones Registradas</h5>
            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalCrearDevolucion">
                ➕ Nueva Devolución
            </button>
        </div>
        ...
        <div style="overflow-x: auto; border-radius: 8px;">
            <table class="table table-dark table-hover" style="margin: 0; background-color: rgba(20, 20, 25, 0.8);">
                <thead style="background: rgba(0, 102, 204, 0.15);">
                    <tr>
                        <th style="color: #0066cc; font-weight: 700;">Nº Devolución</th>
                        <th style="color: #0066cc; font-weight: 700;">Cliente</th>
                        <th style="color: #0066cc; font-weight: 700;">Fecha</th>
                        <th style="color: #0066cc; font-weight: 700;">Producto</th>
                        <th style="color: #0066cc; font-weight: 700;">Monto</th>
                        <th style="color: #0066cc; font-weight: 700;">Estado</th>
...
<div class="modal fade" id="modalCrearDevolucion" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="background: rgba(20, 20, 25, 0.95); border: 1px solid rgba(0, 102, 204, 0.3);">
            <form id="formDevolucion" method="POST" action="{{ route('devoluciones.store') }}">
                @csrf
                <div class="modal-header" style="background: rgba(0, 102, 204, 0.15); border-bottom: 2px solid #0066cc;">
                    <h5 class="modal-title" style="color: #0066cc; font-weight: 700;">➕ Nueva Devolución de Venta</h5>
                ...
                <div class="modal-body" style="color: #f0f0f0; padding: 1.5rem; max-height: 80vh; overflow-y: auto;">
                    ...
                    <!-- SELECCIONAR VENTA -->
                    <h6 style="color: #0066cc; font-weight: 700; margin-bottom: 1rem;">📅 Seleccionar Venta</h6>
                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #f0f0f0;">Venta *</label>
                        <input type="text" id="buscadorVenta" class="form-control form-control-sm" placeholder="Busca por número, cliente o monto..." autocomplete="off" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(0, 102, 204, 0.3); color: #f0f0f0; font-size: 0.9rem;">
                        <input type="hidden" name="venta_id" id="ventaId">
                        <div id="listaVentas" style="display: none; position: absolute; background: rgba(20, 20, 25, 0.95); border: 1px solid rgba(0, 102, 204, 0.3); border-radius: 6px; width: 100%; max-height: 200px; overflow-y: auto; z-index: 1000; margin-top: 0.25rem;"></div>
                    </div>
                    ...
                    <hr style="border-color: rgba(0, 102, 204, 0.3); margin: 1rem 0;">

                    <!-- PRODUCTOS -->
                    <h6 style="color: #0066cc; font-weight: 700; margin-bottom: 1rem;">📦 Selecciona Productos para Devolver</h6>
                    <div class="table-responsive mb-3" style="border: 1px solid rgba(0, 102, 204, 0.2); border-radius: 6px;">
                        <table class="table table-sm" style="margin: 0; background-color: rgba(20, 20, 25, 0.8);">
                            <thead style="background: rgba(0, 102, 204, 0.15);">
                                <tr>
                                    <th style="color: #0066cc; width: 5%; text-align: center; font-size: 0.8rem;">✓</th>
                                    <th style="color: #0066cc; font-size: 0.8rem;">Producto</th>
                                    <th style="color: #0066cc; width: 10%; text-align: center; font-size: 0.8rem;">Cant.Orig</th>
                                    <th style="color: #0066cc; width: 12%; text-align: center; font-size: 0.8rem;">Cant.Dev</th>
                                    <th style="color: #0066cc; width: 12%; text-align: right; font-size: 0.8rem;">Precio Base</th>
                                    <th style="color: #0066cc; width: 13%; text-align: right; font-size: 0.8rem;">Subtotal</th>
                                </tr>
                            </thead>
                    ...
                    <!-- DETALLES -->
                    <h6 style="color: #0066cc; font-weight: 700; margin-bottom: 1rem;">📄 Detalles de Devolución</h6>

                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #f0f0f0;">Motivo *</label>
                        <textarea name="motivo" id="motivo" class="form-control form-control-sm" rows="3" placeholder="Describe el motivo..." required style="background: rgba(20, 20, 25, 0.8); border-color: rgba(0, 102, 204, 0.3); color: #f0f0f0; font-size: 0.9rem;"></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #f0f0f0;">Estado *</label>
                        <select name="estado" id="estado" class="form-select form-select-sm" required style="background: rgba(20, 20, 25, 0.8); border-color: rgba(0, 102, 204, 0.3); color: #f0f0f0; font-size: 0.9rem;">
    ...
    <option value="completada" selected style="background: rgba(20, 20, 25); color: #f0f0f0;">Completada</option>
                    ...
                    <div style="background: rgba(0, 102, 204, 0.1); padding: 1rem; border-radius: 6px; border-left: 3px solid #0066cc;">
                        ...
                        <div class="d-flex justify-content-between" style="font-size: 0.9rem; margin-bottom: 0.5rem;">
                            ...
                            <strong id="montoIva" style="color: #ffc107;">€0.00</strong>
                        </div>
                        <div class="d-flex justify-content-between" style="font-size: 1rem; padding-top: 0.75rem; border-top: 1px solid rgba(0, 102, 204, 0.3);">
                            <span style="color: #0066cc; font-weight: 700;">A DEVOLVER (SIN IVA):</span>
                ...
                <div class="modal-footer" style="border-top: 1px solid rgba(0, 102, 204, 0.3);">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancelar</button>
                    <button type="submit" class="btn btn-primary btn-sm">✓ Guardar Devolución</button>
                </div>
...
<div class="modal fade" id="modalVerDevolucion" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="background: rgba(20, 20, 25, 0.95); border: 1px solid rgba(0, 102, 204, 0.3);">
            <div class="modal-header" style="background: rgba(0, 102, 204, 0.15); border-bottom: 2px solid #0066cc;">
                <h5 class="modal-title" style="color: #0066cc; font-weight: 700;">📋 Detalles de la Devolución</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            ...
            <div class="modal-body" style="color: #f0f0f0; padding: 1.5rem; max-height: 80vh; overflow-y: auto;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <h6 style="color: #0066cc; font-weight: 700; margin-bottom: 1rem;">📌 Información</h6>
                        <div style="background: rgba(0, 102, 204, 0.1); padding: 1rem; border-radius: 6px; border-left: 3px solid #0066cc;">
                            <div style="margin-bottom: 0.5rem;">
                                <span style="color: #a0a0a0; font-size: 0.85rem;">Código:</span>
                                <strong id="verCodigo" style="color: #0066cc; display: block;">DEV-0001</strong>
                            </div>
                            <div style="margin-bottom: 0.5rem;">
                    ...
                    <div class="col-md-6">
                        <h6 style="color: #0066cc; font-weight: 700; margin-bottom: 1rem;">⚙️ Estado y Totales</h6>
                        <div style="background: rgba(0, 102, 204, 0.1); padding: 1rem; border-radius: 6px; border-left: 3px solid #0066cc;">
                            <div style="margin-bottom: 0.5rem;">
                ...
                <hr style="border-color: rgba(0, 102, 204, 0.3); margin: 1.5rem 0;">

                <h6 style="color: #0066cc; font-weight: 700; margin-bottom: 1rem;">📦 Productos Devueltos</h6>
                <div class="table-responsive mb-3" style="border: 1px solid rgba(0, 102, 204, 0.2); border-radius: 6px;">
                    <table class="table table-sm" style="margin: 0; background-color: rgba(20, 20, 25, 0.8);">
                        <thead style="background: rgba(0, 102, 204, 0.15);">
                            <tr>
                                <th style="color: #0066cc; font-size: 0.8rem;">Producto</th>
                                <th style="color: #0066cc; width: 12%; text-align: center; font-size: 0.8rem;">Cantidad</th>
                                <th style="color: #0066cc; width: 18%; text-align: right; font-size: 0.8rem;">Precio Base</th>
                                <th style="color: #0066cc; width: 18%; text-align: right; font-size: 0.8rem;">Subtotal</th>
                            </tr>
                        </thead>
                        <tbody id="verProductos" style="color: #f0f0f0; font-size: 0.875rem;">
                        </tbody>
                        <tfoot style="background: rgba(0, 102, 204, 0.05); border-top: 2px solid rgba(0, 102, 204, 0.3);">
                            <tr>
                                <td colspan="3" style="text-align: right; font-weight: 700; color: #0066cc;">TOTAL (SIN IVA):</td>
                ...
                <h6 style="color: #0066cc; font-weight: 700; margin-bottom: 0.5rem;">💬 Motivo:</h6>
                <div style="background: rgba(20, 20, 25, 0.8); padding: 0.75rem; border-radius: 6px; border-left: 3px solid #0066cc; color: #a0a0a0; font-size: 0.9rem;">
            ...
            <div class="modal-footer" style="border-top: 1px solid rgba(0, 102, 204, 0.3);">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="window.print()">🖨️ Imprimir</button>
            </div>
                ...
                .then(data => {
                    ...
                    if (filtrados.length > 0) {
                        filtrados.forEach(venta => {
                            ...
                            item.style.cssText = 'padding: 0.5rem 1rem; cursor: pointer; border-bottom: 1px solid rgba(0, 102, 204, 0.2); color: #f0f0f0;';
                            item.innerHTML = `<strong style="color: #0066cc;">${venta.numero_factura}</strong> - ${venta.cliente} - <span style="color: #28a745;">€${parseFloat(venta.total).toFixed(2)}</span>`;
                ...
                const row = `
                    <tr>
                        <td style="text-align: center;">
                            <input type="checkbox" class="form-check-input checkbox-producto" data-id="${detalle.id}" onchange="actualizarFila(this)" style="cursor: pointer;">
                        </td>
                        <td style="color: #f0f0f0;">${detalle.producto?.nombre || 'Desconocido'}</td>
                        <td style="text-align: center; color: #0066cc;">${cantidad}</td>
                        <td style="text-align: center;">
                            <input type="number" class="form-control form-control-sm cantidad-devuelta" value="0" min="0" max="${cantidad}" data-precio-base="${precioBase}" onchange="actualizarFila(this)" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(0, 102, 204, 0.3); color: #f0f0f0; text-align: center; width: 60px;">
                        </td>
                        <td style="text-align: right; color: #28a745;">€${precioBase.toFixed(2)}</td>
                        <td style="text-align: right; color: #0066cc; font-weight: 600;">€0.00</td>
                    </tr>
                `;
                tbody.innerHTML += row;
            });
    ...
    function verDevolucion(id) {
        fetch(`/devoluciones/${id}/json`)
            ...
            .then(data => {
                ...
                estadoSpan.style.background = data.estado === 'completada' ? '#28a745' : '#ffc107';
                    ...
                    data.detalles.forEach(det => {
                        ...
                        const row = `
                            <tr>
                                ...
                                <td style="text-align: right; color: #0066cc;">${subtotal.toFixed(2)}</td>
                            </tr>
                        `;
                        tbody.innerHTML += row;
                    });
