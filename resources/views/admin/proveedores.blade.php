    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background: rgba(20, 20, 25, 0.95); border: 1px solid rgba(230, 57, 70, 0.3); border-radius: 8px;">
            <form id="formEditarProveedor">
                ...
                <div class="modal-header" style="background: rgba(230, 57, 70, 0.15); border-bottom: 2px solid #e63946; padding: 0.75rem 1rem;">
                    <h5 class="modal-title fw-bold" style="color: #e63946; margin: 0;">✏️ Editar Proveedor</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" style="color: #f0f0f0; padding: 1rem;">
                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #e63946;">Nombre *</label>
                        <input type="text" name="nombre" id="edit_nombre" class="form-control form-control-sm" required style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 32px; font-size: 0.85rem;">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #e63946;">Contacto</label>
                        <input type="text" name="contacto_nombre" id="edit_contacto_nombre" class="form-control form-control-sm" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 32px; font-size: 0.85rem;">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #e63946;">Teléfono</label>
                        <input type="text" name="contacto_telefono" id="edit_contacto_telefono" class="form-control form-control-sm" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 32px; font-size: 0.85rem;">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #e63946;">Email</label>
                        <input type="email" name="email" id="edit_email" class="form-control form-control-sm" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 32px; font-size: 0.85rem;">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #e63946;">Dirección</label>
                        <textarea name="direccion" id="edit_direccion" class="form-control form-control-sm" rows="2" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; font-size: 0.85rem;"></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold" style="font-size: 0.85rem; color: #e63946;">Estado</label>
                        <select name="activo" id="edit_activo" class="form-select form-select-sm" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 32px; font-size: 0.85rem;">
...
<!-- ============ MODAL CREAR PROVEEDOR CON FORMA DE PAGO ============ -->
        ...
        <div class="modal-content" style="background: rgba(20, 20, 25, 0.95); border: 1px solid rgba(230, 57, 70, 0.3); border-radius: 8px;">
            <form action="{{ route('proveedores.store') }}" method="POST">
                ...
                <div class="modal-body" style="color: #f0f0f0; padding: 1rem; max-height: 70vh; overflow-y: auto;">
                    ...
                    <!-- SECCIÓN: FORMA DE PAGO (OBLIGATORIO) -->
                    <div style="display: grid; grid-template-columns: auto 1fr; gap: 0.5rem; align-items: center; margin-bottom: 0.75rem; padding: 0.6rem; background: rgba(230, 57, 70, 0.08); border-radius: 6px; border-left: 3px solid #e63946;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem; margin-bottom: 0.5rem;">
                        <div>
                            ...
                            <select name="forma_pago_id" id="formaPagoSelect" class="form-select form-select-sm" required style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 30px; font-size: 0.8rem;">
                        ...
                        <div>
                            ...
                            <select name="banco_id" id="bancoSelect" class="form-select form-select-sm" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 30px; font-size: 0.8rem;">
                                <option value="">Selecciona...</option>
                    ...
                    <div style="margin-bottom: 0.5rem;">
                        <label class="form-label fw-bold" style="font-size: 0.75rem; color: #e63946; margin-bottom: 0.15rem;">Referencia (IBAN, Cheque, etc.)</label>
                        <input type="text" name="referencia" class="form-control form-control-sm" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 30px; font-size: 0.8rem;" placeholder="Ej: ES91 1234 5678...">
                    </div>

                    <div style="margin-bottom: 0.5rem;">
                        <label class="form-label fw-bold" style="font-size: 0.75rem; color: #e63946; margin-bottom: 0.15rem;">Nombre Banco (Descripción)</label>
                        <input type="text" name="nombre_banco" class="form-control form-control-sm" style="background: rgba(20, 20, 25, 0.8); border-color: rgba(230, 57, 70, 0.3); color: #f0f0f0; height: 30px; font-size: 0.8rem;" placeholder="Ej: Cuenta corriente principal">
                    </div>

                    <p style="font-size: 0.7rem; color: #a0a0a0; margin-top: 0.4rem; margin-bottom: 0;"><strong>ℹ️ Nota:</strong> Esta forma de pago es obligatoria. Podrás agregar más posteriormente.</p>
