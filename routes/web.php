...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Stocks
    Route::get('/stocks', [StockController::class, 'index'])->name('admin.index');
// ============ VENTAS ============
Route::middleware(['auth', 'role:admin'])->prefix('ventas')->group(function () {
    ...
    // ========== RUTAS API (SIN PREFIJO DE COMPRAS) ==========
