<?php
// database/migrations/2026_03_21_999999_create_devoluciones_tables.php
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // =============================================
        // 3. Tabla: devoluciones_detalle (con foreign keys después)
        // =============================================
        Schema::create('devoluciones_detalle', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('devolucion_compra_id')->nullable();
            $table->unsignedBigInteger('devolucion_venta_id')->nullable();
        ...
        // Añadir las claves foráneas DESPUÉS de crear todas las tablas
        Schema::table('devoluciones_detalle', function (Blueprint $table) {
            $table->foreign('devolucion_compra_id')
                  ->references('id')
                  ->on('devolucion_compras')
                  ->onDelete('cascade');
