...
class CompraSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $productoRtx = $productos->where('sku', 'RTX4060')->first();
        $productoSamsung = $productos->where('sku', 'SAMSUNG-980-1TB')->first();
        $productoCorsair = $productos->where('sku', 'CORSAIR-16GB')->first();
        ...
        $productoRyzen5 = $productos->where('sku', 'RYZ5-5600G')->first();
        $productoRyzen7 = $productos->where('sku', 'RYZ7-5700X')->first();
        ...
        $compraId3 = DB::table('compras')->insertGetId([
            ...
            'estado' => 'recibido',
            'usuario_id' => $admin->id,
            'observaciones' => 'Stock de periféricos Logitech',
            'created_at' => '2025-03-10 11:00:00',
            'updated_at' => '2025-03-14 10:15:00'
        ]);

        $productoG203 = $productos->where('sku', 'LOG-G203')->first();
        $productoG502 = $productos->where('sku', 'LOG-G502')->first();
        ...
        $productoIntel = $productos->where('sku', 'INTEL-I5-12400F')->first();
    ...
    /**
     * Método auxiliar para registrar movimientos de stock
     */
